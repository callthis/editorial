...
As such, to prevent malpractices, malfeasance, and overall disservice to customers, pharmacists must continue to be vigilant and more critical, of prescribing doctors as well as pharmaceutical corporations that are able to manipulate doctors using financial inducements, into over-prescribing their name-brand formulations. 
